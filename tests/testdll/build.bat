@echo off
rem ========================================================================
rem build.bat -- build TestWin8Api.dll, CRT-free, x64.
rem ========================================================================
setlocal
...
echo --- building TestWin8Api.dll ---
cl %CFLAGS% TestWin8Api.c /FeTestWin8Api.dll /link %LFLAGS% /ENTRY:DllMain || goto :fail

del /q *.obj *.exp *.lib 2>nul
echo OK: TestWin8Api.dll
exit /b 0
